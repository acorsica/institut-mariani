...
Ce dépôt documente la mission, les initiatives, les liens de corpus et les préfigurations développées dans le périmètre de l’Institut Mariani.

## Mission

L’Institut Mariani a pour vocation de développer, documenter et mettre à disposition des communs démocratiques, cognitifs, civiques, patrimoniaux, énergétiques et numériques.

Il contribue notamment à :

- la recherche sur la gouvernance démocratique ;
- la traçabilité des actes ;
- l’assistance cognitive sans transfert de souveraineté ;
- les infrastructures civiques multi-instances ;
- les jumeaux numériques et signatures structurelles ;
...
Le français est la langue de référence des documents institutionnels liés à C.O.R.S.I.C.A. et à l’Institut Mariani.
